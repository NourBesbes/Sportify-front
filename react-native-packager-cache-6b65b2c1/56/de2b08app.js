var firebase = function () {
    ...
    var firebase = null;(function () {
        ...
        "undefined" !== typeof A.S && A.S || (A.__extends = __extends, A.__assign = __assign, A.__rest = __rest, A.__extends = __extends, A.__decorate = __decorate, A.__metadata = __metadata, A.__param = __param, A.__awaiter = __awaiter, A.__generator = __generator);var B = function B(a) {
            if (Error.captureStackTrace) Error.captureStackTrace(this, B);else {
                var b = Error().stack;b && (this.stack = b);
            }a && (this.message = String(a));
        };y(B, Error);B.prototype.name = "CustomError";var ga = function ga(a, b) {
            for (var c = a.split("%s"), d = "", e = Array.prototype.slice.call(arguments, 1); e.length && 1 < c.length;) {
                d += c.shift() + e.shift();
            }return d + c.join("%s");
        };var C = function C(a, b) {
            b.unshift(a);B.call(this, ga.apply(null, b));b.shift();
        };y(C, B);C.prototype.name = "AssertionError";var ha = function ha(a, b, c, d) {
        ...
        J.prototype.reset = function () {
            ...
            if (-1 != String(r.Promise).indexOf("[native code]")) {
                ...
                var a = pa;!v(r.setImmediate) || r.Window && r.Window.prototype && -1 == G.indexOf("Edge") && r.Window.prototype.setImmediate == r.setImmediate ? (H || (H = la()), H(a)) : r.setImmediate(a);
            };
        },
            L = !1,
            oa = new I(),
        ...
        var N = function N(a, b, c) {
            ...
            if (a instanceof O) return null != b && E(b, "opt_onFulfilled should be a function."), null != c && E(c, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"), xa(a, sa(b || t, c || null, d)), !0;var e;if (a) try {
                e = !!a.$goog_Thenable;
            } catch (g) {
                e = !1;
